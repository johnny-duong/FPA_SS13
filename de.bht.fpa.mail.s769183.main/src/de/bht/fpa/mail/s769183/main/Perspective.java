...
public class Perspective implements IPerspectiveFactory {
	private static final String PERSPECTIVE_ID = Activator.PLUGIN_ID
			+ ".perspective";
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		layout.createPlaceholderFolder(LEFT, IPageLayout.LEFT, LEFT_RATIO,
				editorAreaId);
		layout.createPlaceholderFolder(TOP, IPageLayout.TOP, TOP_RATIO,
				editorAreaId);
		layout.createPlaceholderFolder(BOTTOM, IPageLayout.BOTTOM,
				BOTTOM_RATIO, editorAreaId);
	}
}
